...
# <-- Removed inner constructor tests here

# <-- Removed outer constructor tests here

# <-- Removed layering tests here
...
#     @test (modified_adjoint(realvec) * realmat)::Adjoint{Int,Vector{Int}} ==
#         reshape(copy(modified_adjoint(realmat)) * realvec, (1, 3))
#     @test (modified_transpose(realvec) * realmat)::Transpose{Int,Vector{Int}} ==
#         reshape(copy(modified_transpose(realmat)) * realvec, (1, 3))
#     @test (modified_adjoint(complexvec) * complexmat)::Adjoint{Complex{Int},Vector{Complex{Int}}} ==
#         reshape(conj(copy(modified_adjoint(complexmat)) * complexvec), (1, 3))
#     @test (modified_transpose(complexvec) * complexmat)::Transpose{Complex{Int},Vector{Complex{Int}}} ==
#         reshape(copy(modified_transpose(complexmat)) * complexvec, (1, 3))
#     # Adjoint/Transpose-vector * Adjoint/Transpose-matrix
#     @test (modified_adjoint(realvec) * modified_adjoint(realmat))::Adjoint{Int,Vector{Int}} ==
#         reshape(realmat * realvec, (1, 3))
#     @test (modified_transpose(realvec) * modified_transpose(realmat))::Transpose{Int,Vector{Int}} ==
#         reshape(realmat * realvec, (1, 3))
#     @test (modified_adjoint(complexvec) * modified_adjoint(complexmat))::Adjoint{Complex{Int},Vector{Complex{Int}}} ==
#         reshape(conj(complexmat * complexvec), (1, 3))
#     @test (modified_transpose(complexvec) * modified_transpose(complexmat))::Transpose{Complex{Int},Vector{Complex{Int}}} ==
...
#     # /(Adjoint/Transpose-vector, matrix)
#     @test (modified_adjoint(realvec) / realmat)::Adjoint ≈ rowrealvec / realmat
#     @test (modified_adjoint(complexvec) / complexmat)::Adjoint ≈ conj(rowcomplexvec) / complexmat
#     @test (modified_transpose(realvec) / realmat)::Transpose ≈ rowrealvec / realmat
#     @test (modified_transpose(complexvec) / complexmat)::Transpose ≈ rowcomplexvec / complexmat
#     # /(Adjoint/Transpose-vector, Adjoint matrix)
#     @test (modified_adjoint(realvec) / modified_adjoint(realmat))::Adjoint ≈ rowrealvec / copy(modified_adjoint(realmat))
#     @test (modified_adjoint(complexvec) / modified_adjoint(complexmat))::Adjoint ≈ conj(rowcomplexvec) / copy(modified_adjoint(complexmat))
#     @test (modified_transpose(realvec) / modified_adjoint(realmat))::Transpose ≈ rowrealvec / copy(modified_adjoint(realmat))
#     @test (modified_transpose(complexvec) / modified_adjoint(complexmat))::Transpose ≈ rowcomplexvec / copy(modified_adjoint(complexmat))
#     # /(Adjoint/Transpose-vector, Transpose matrix)
#     @test (modified_adjoint(realvec) / modified_transpose(realmat))::Adjoint ≈ rowrealvec / copy(modified_transpose(realmat))
#     @test (modified_adjoint(complexvec) / modified_transpose(complexmat))::Adjoint ≈ conj(rowcomplexvec) / copy(modified_transpose(complexmat))
#     @test (modified_transpose(realvec) / modified_transpose(realmat))::Transpose ≈ rowrealvec / copy(modified_transpose(realmat))
#     @test (modified_transpose(complexvec) / modified_transpose(complexmat))::Transpose ≈ rowcomplexvec / copy(modified_transpose(complexmat))
# end
#
